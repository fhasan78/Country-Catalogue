...
public class TestCountry {
	...
	public static void main(String[] args) {
		...
		if (!name.equals("France"))
			test = false;
		if (cntry.getPopulation() != FRANCE_POPULATION)
			test = false;
		if (cntry.getArea() != FRANCE_AREA)
			test = false;
		if (!cntry.getContinent().equals("Asia"))
			test = false;
		if (cntry.getPopDensity() != FRANCE_POPULATION / FRANCE_AREA)
			test = false;
		cntry.setPopulation(50000);
		if (cntry.getPopulation() != 50000)
			test = false;
		cntry.setContinent("Europe");
		if (!cntry.getContinent().equals("Europe"))
			test = false;
		...
		if (!line.contains("France") || !line.contains("Europe") || !line.contains("50000") || !line.contains("2.5"))
			test = false;
		...
		test = true;
		line = cntry.toString();
		if (!line.contains("France") || !line.contains("Europe"))
			test = false;
		if (test == false)
			...
			System.out.println(
					"France is located in Europe has a population of 50000, an area of 20000.0, and has a population density of 2.5");
